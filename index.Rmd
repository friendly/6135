---
title: "Psyc 6135: Psychology of Data Visualization"
...
<img src="images/icons/construction.png" height=20> These web pages reflect the course when it was last taught in 2022. Much will remain the same, but details, readings and assignments are being reconsidered for this year. If you find a link that doesn't work, or could be replaced by something better or more recent, 
...
- [1up PDF](lectures/Overview.pdf) || [4up PDF](lectures/Overview-2x2.pdf)
...
- **Lecture notes**: `r icon::fa("file-pdf", color="red")` [1up PDF](lectures/Varieties.pdf) || [4up PDF](lectures/Varieties-2x2.pdf)
- **Assignment**:
...
#### Lecture notes `r icon::fa("file-pdf", color="red")`
- Overview [1up PDF](lectures/History.pdf) || [4up PDF](lectures/History-2x2.pdf)
...
#### Lecture notes  `r icon::fa("file-pdf", color="red")` 
- [1up PDF](lectures/GraphPerception.pdf) || [4up PDF](lectures/GraphPerception-2x2.pdf)
...
- **Lecture notes**: `r icon::fa("file-pdf", color="red")` [1up PDF](lectures/HumanFactors.pdf) || [4up PDF](lectures/HumanFactors-2x2.pdf)
...
- **Lecture notes**: `r icon::fa("file-pdf", color="red")` [1up PDF](lectures/Language.pdf) || [4up PDF](lectures/Language-2x2.pdf)
...
#### Lecture notes & tutorial `r icon::fa("file-pdf", color="red")`
...
* Plots of cars data with ggplot2: [gg-cars.R](R/gg-cars.R). Output: [gg-cars.html](R/gg-cars.html)
...
- **Lecture notes**: `r icon::fa("file-pdf", color="red")` [1up PDF](lectures/ggplot-further.pdf) || [4up PDF](lectures/ggplot-further-2x2.pdf)
- **Lecture notes**: Bootstrapping  `r icon::fa("file-pdf", color="red")` [1up PDF](lectures/bootstrap.pdf) || [4up PDF](lectures/bootstrap-2x2.pdf)
...
- Lecture notes: `r icon::fa("file-pdf", color="red")` [1up PDF](lectures/Uncertainty.pdf) || [4up PDF](lectures/Uncertainty-2x2.pdf)
...
- Lecture notes: `r icon::fa("file-pdf", color="red")` [1up PDF](lectures/DataJournalism.pdf) || [4up PDF](lectures/DataJournalism-2x2.pdf)
...
## 2022 Student presentations `r icon::fa("chalkboard-teacher", color="red")`
