...
- **Lecture notes**: `r icon::fa("file-pdf", color="red")` [1up PDF](lectures/Overview.pdf); [4up PDF](lectures/Overview-2x2.pdf)
...
- **Lecture notes**: `r icon::fa("file-pdf", color="red")` [1up PDF](lectures/GraphPerception.pdf); [4up PDF](lectures/GraphPerception-2x2.pdf)
...
- **Hadley Wickham**. [Tidy data](https://www.jstatsoft.org/v059/i10). _The Journal of Statistical Software_, vol. **59**, 2014. See also the
