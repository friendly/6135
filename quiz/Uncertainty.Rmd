---
title: "Visualizing Uncertainty Quiz"
...
```{r q10, echo=FALSE}
question("According to the {ggdist} package philosophy, what are the three key elements that can be combined for visualizing uncertainty?",
