...
tab(class="cellpadding", width="800px",
  ...
  tr(
    ...
    tabtxt(
      ...
      ". A practical guide for creating compelling graphics to explain and explore data, primarily aimed at designers, journalists, researchers, analysts, and other professionals who want to learn the basics of visualization",
      br(),
