...
tab(class="cellpadding", width="800px",
  ...
  tr(
  	tabfig("Christiansen", "images/books/Wilke-FundamentalsOfDataVis.png",
  	       "https://www.buildingsciencegraphics.com/", width=width),
  	tabtxt("Jen Christiansen,",  a("Building Science Graphics",
...
* **Other graphic software**: 
  ...
  + [Figma](https://www.figma.com/), a graphic design system
