...
* Salomé Esteves [The people DataViz’s history ignores: a step forward to an intersectional history of Data Visualization](papers/Esteves-People_DataViz_history_ignores.pdf). An attempt to broaden the history of dataviz.
...
### Session 9: Visualizing Uncertainty {#week7}
...
- **Accessibility**: Making graphics accessible to the visually impaired. A simple example is **ALT** text, now increasingly used.  Are there standards or tools available? 
  * Somewhat related: Data **sonification & haptics**-- using sound and other modalities.
